    ...
    <div className="carousel my-12 mx-auto">
      ...
      <div className="relative overflow-hidden">
        <div className="flex justify-between absolute top left w-full h-full">
          ...
          <button
            onClick={moveNext}
            className="hover:bg-green-900/75 text-black w-10 h-full text-center opacity-100 hover:opacity-100 disabled:opacity-25 disabled:cursor-not-allowed z-10 p-0 m-0 transition-all ease-in-out duration-300"
              ...
              >
                ...
                >
                  <img
                    ...
                    alt={resource.title}
                    className="w-full aspect-square hidden hover:scale-125"
                  />
                </a>
                <a
                  href={resource.link}
